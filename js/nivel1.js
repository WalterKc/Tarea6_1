...
let A=1;
let B=2;
let num1 = Number((prompt('Ingrese el valor a sumar')==;
let num2 = Number(prompt('Ingrese otro valor'));
...
////////////////////////////////////////////////////////////////////////////
// Felicitaciones! Terminaste el Nivel 1 de la introducción a JavaScript! //2920
...
function calcular_salario(mensual,diario,hora,salario,dias_trabajados_semana,horas_ala_semana)
 {
    ...
    if(diario){
        return (salario/dias_trabajado_por_semana)
    }if(hora){
        return (salario/(horas_al_dia*dias_trabajado_por_semana*52.1428) )
    }
};
...
//tarea 1
let nombre_usuario=prompt("¿cual es tu nombre?").toLowerCase()
let mi_nombre="Walter".toLowerCase()
let nombre_primo="Elias".toLowerCase()
if (mi_nombre===nombre_usuario){
    console.log(`hola Tocayo!, yo tambien me llamo ${mi_nombre} `)
    
    
    
}else if(nombre_primo===nombre_usuario){
    console.log(`hola ${nombre_usuario}, te llamas igual a mi primo`)
}else{
...
//tarea 2
let edad_usuario=Number(prompt("¿cual es tu edad?"))
let mi_edad=25
if (edad_usuario===mi_edad){
    console.log(`${nombre_usuario} tienes mi misma edad`)
}else if(edad_usuario>mi_edad){
    console.log(`${nombre_usuario} eres mayor que a mi`)
}else{
    console.log(`${nombre_usuario} eres menor que a mi`)
}
//tarea 3
let tienes_documento=prompt("¿tienes documento?").toLowerCase()
if (tienes_documento==="si"){
    edad_usuario()
}